...
const roles = ['Maintenance Companies', 'Bank and Mortgage Companies', 'Evaluation Companies', 'Marketing Companies'];
...
const AutocompleteFormManagement = () => {
...
export default AutocompleteFormManagement;
