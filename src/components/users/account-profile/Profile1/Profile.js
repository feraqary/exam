            ...
            <SubCard title="Skills">
              <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                  ...
                  <LinearProgressWithLabel color="primary" variant="determinate" aria-label="junior skill progress" value={70} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">UX Researcher</Typography>
                  <LinearProgressWithLabel color="primary" variant="determinate" aria-label="Researcher skill progress" value={80} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">Wordpress</Typography>
                  <LinearProgressWithLabel color="secondary" variant="determinate" aria-label="Wordpress skill progress" value={25} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">Graphic Designer</Typography>
                  <LinearProgressWithLabel color="primary" variant="determinate" aria-label="Graphic skill progress" value={80} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">HTML</Typography>
                  <LinearProgressWithLabel color="secondary" variant="determinate" aria-label="HTML skill progress" value={45} />
                </Grid>
                <Grid item xs={12} md={6}>
                  <Typography variant="body2">PHP</Typography>
                  <LinearProgressWithLabel color="primary" variant="determinate" aria-label="PHP skill progress" value={65} />
                </Grid>
              </Grid>
            </SubCard>
          </Grid>
