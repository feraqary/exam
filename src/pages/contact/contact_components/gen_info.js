        ...
        <Grid item xs={12}>
          <Container title="General Information" style={{ xs: 12 }}>
            <Grid container spacing={2} alignItems="center">
              <AutoCompleteSelector label="Select Company" style={{ xs: 12, lg: 6 }} options={companies} placeholder="select company" />

              <InputDateTime label="Date Of Birth" style={{ xs: 12, lg: 6 }} />

              <AutoCompleteSelector label="Proffession" style={{ xs: 12, lg: 6 }} options={companies} placeholder="select proffession" />
            ...
            <Grid container spacing={2} alignItems="center">
              <Grid item lg={6}>
                ...
                <InputText
                  ...
                  // setValue={setValue}
                />
                <Grid item lg={12} padding="16px 0px 0px 16px"></Grid>
                <Grid item lg={12} padding="16px 0px 0px 16px"></Grid>
                <Grid item lg={12} padding="16px 0px 0px 16px"></Grid>
              </Grid>
              ...
              <Grid item lg={6} alignItems="center">
                ...
                <Grid item xs={12} lg={12}>
                  <FormGroup row>
                    <FormControlLabel control={<Checkbox value={'i'} />} label="Same as residence" labelPlacement="start" />
                  </FormGroup>
                  <FormGroup row>
                    <FormControlLabel control={<Checkbox value={'i'} />} label="Same as company" labelPlacement="start" />
                  </FormGroup>
                </Grid>
                <InputText
              ...
              <Grid item lg={6} padding="16px 0px 0px 16px"></Grid>
            </Grid>
          </Container>
          ...
          <MainCard title="Direct Marketing">
            <Grid container spacing={2} alignItems="center">
              <Grid item xs={12} lg={12} justifyContent="center">
                <FormGroup row>
                  <FormControlLabel control={<Checkbox value={'i'} />} label="General Information" labelPlacement="start" />
                  <FormControlLabel control={<Checkbox value={'i'} />} label="Property Listings" labelPlacement="start" />
                  <FormControlLabel control={<Checkbox value={'i'} />} label="SMS Updates" labelPlacement="start" />
                  <FormControlLabel control={<Checkbox value={'i'} />} label="Newletter" labelPlacement="start" />
                </FormGroup>
              </Grid>
            </Grid>
          </MainCard>
