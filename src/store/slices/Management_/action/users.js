...
export const getAllUserRoles = createAsyncThunk('userRoles/getAllUserRoles', async (_, { rejectWithValue }) => {
    try {
      const response = await axios.get(`${baseurl}/api/user/getAllRoles`,config);
